...
2 - ESP32 - ESP32 (ESP32 Master as transmitter):<br> 
...
3 - ESP32 - ESP32 (ESP32 Master as receiver):<br> 
...
4 - ESP32 - Raspberry Pi 5 (Raspberry Pi 5 Master as receiver):<br> 
...
5 - STM32 - Raspberry Pi 5 (Raspberry Pi 5 Master as receiver):<br> 
...
   &nbsp;&nbsp;6 - SPI_ESP32_Master_receive.c file receives a char from the slave<br>
   &nbsp;&nbsp;6 - SPI_STM32_Slave_main.c file sends a char to the master
